    ...
    <div class="nk-block">
        <div class="row g-3">
            ...
            <form name="productForm" action="{{route('products.update', $product->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control" id="product_name" name="product_name" value="{{old('product_name') ? old('product_name'): $product->product_name}}">
                        </div>
                    </div>
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                    <button type="submit" class="btn btn-primary"><em class="icon ni ni-plus"></em><span>Update Product</span></button>
                </div>
            </form>
        </div>
    </div><!-- .nk-block -->
