                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul class="link-list-opt no-bdr">
                                                        ...
                                                        <li><form method="post" onSubmit="return confirm('Are you sure?')" action="{{route('products.destroy', $product->id)}}" class="remove">
                                                            {{method_field('DELETE')}}
                                                            @csrf
                                                            <button type="submit"> <em class="icon ni ni-trash"><span>Remove Product</em></button></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </li>
